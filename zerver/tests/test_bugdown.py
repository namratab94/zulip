...
class BugdownTest(TestCase):
    ...
    def test_image_preview(self):
        ...
        self.assertEqual(
            ...
            '</p>'
            '\n<div class="message_inline_image"><a href="https://example.com/testimage.png" target="_blank" title="My favorite image"><img src="https://example.com/testimage.png"></a></div>'
        )
